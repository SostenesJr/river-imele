...
var I18N = {
  ...
  pt: {
    ...
    sheet_size_p_title: 'Balão pequeno (tamanho normal)',
    sheet_size_m_title: 'Balão médio (30% maior)',
    sheet_size_g_title: 'Balão grande (50% maior)',
    logout_title: 'Sair',
    ...
    emb_dias_label: 'Sai', emb_dias_nao_informado: 'Dias de saída não informados.',
  ...
  en: {
    ...
    sheet_size_p_title: 'Small popup (normal size)',
    sheet_size_m_title: 'Medium popup (30% bigger)',
    sheet_size_g_title: 'Large popup (50% bigger)',
    ...
    emb_dias_label: 'Leaves', emb_dias_nao_informado: 'Departure days not informed.',
  ...
  es: {
    ...
    sheet_size_p_title: 'Globo pequeño (tamaño normal)',
    sheet_size_m_title: 'Globo mediano (30% más grande)',
    sheet_size_g_title: 'Globo grande (50% más grande)',
    logout_title: 'Salir',
    ...
    emb_dias_label: 'Sale', emb_dias_nao_informado: 'Días de salida no informados.',
  ...
  zh: {
    ...
    sheet_size_p_title: '小弹窗（正常大小）',
    sheet_size_m_title: '中弹窗（放大30%）',
    sheet_size_g_title: '大弹窗（放大50%）',
    logout_title: '退出登录',
    lang_btn_title: '切换语言',
    ...
    emb_dias_label: '出发', emb_dias_nao_informado: '未填写出发日。',
